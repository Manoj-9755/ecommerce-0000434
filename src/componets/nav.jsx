    ...
    <div>
      <div className="flex justify-between flex-nowrap w-full h-[70px]">
        <div className="w-[30%]">
          ...
          <div className=" w-[32%] flex justify-between   p-2 mr-7">
        ...
        <div className="  w-[30%] flex justify-end mr-7 mt-1  ">
            <div className="relative">
              <input onChange={handlecChange}
                className="  w-[145px] h-[33px] mt-1 px-7 rounded-3xl w-22 border-2 border-gray-300 placeholder:italic shadow-sm placeholder:text-sm"
                placeholder="Search..."
              />
